...
$jmxFileToRun = "TestPlan_WorkLoadCharacterization_Sintetico.jmx"
$jtlOutputFileName = "WorkloadCharacterization_Results_Sintetico.csv" # Nome del file JTL di output
