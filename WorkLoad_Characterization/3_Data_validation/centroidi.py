...
file_excel = "LLSint_PCA7_Cluster14.xlsx"
...
output_filename = f"{file_excel}_WORKLOAD_SINTETICO.xlsx"
...
validation_filename = f"{file_excel}_DATA_VALIDATION.xlsx"
...
print(f"I dati delle componenti principali sono stati salvati nel file Excel: {validation_filename}")